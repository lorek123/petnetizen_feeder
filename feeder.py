...
class FeederDevice:
    ...
    async def feed(self, portions: int = 1) -> bool:
        ...
        try:
            ...
            raise RuntimeError(f"Failed to send feed command: {e}")
    ...
    async def set_schedule(self, schedules: List[FeedSchedule]) -> bool:
        ...
        try:
            ...
            raise RuntimeError(f"Failed to set schedule: {e}")
    ...
    async def set_child_lock(self, locked: bool) -> bool:
        ...
        try:
            ...
            raise RuntimeError(f"Failed to set child lock: {e}")
    ...
    async def set_sound(self, enabled: bool) -> bool:
        ...
        try:
            ...
            raise RuntimeError(f"Failed to set sound: {e}")
